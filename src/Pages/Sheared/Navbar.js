...
const Navbar = () => {
    ...
    const navItems = <>
        ...
        <li className='text-xl'><Link to='/myPortfolio'>My Portfolio</Link></li>
        {user ? <li><button className='btn btn-ghost text-xl' onClick={() => logout()}>Logout
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <div className='text-end'>
                        <label htmlFor="my-drawer-2" className="drawer-button lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg></label>
                    </div>
                </div>
